...
# wave event 
vs = ['hs', 't02', 'dir', 'spr']
waves_event = point_csiro['2000-01-02 00:00':'2000-01-02 12:00'][vs]
...
vs = ['U10', 'V10']
wind_series = point_csiro['2000-01-02 00:00':'2000-01-02 12:00'][vs]

print('\ninput wind series')
print(wind_series)


# set 2 segments with this waves event
segment_01 = {
    'waves_event': waves_event,
    'mode': 'IJ',  # XY (coordinates) or IJ (grid)
    'X': [0,  int(main_mesh.cg['mxc']/4)],  # x/lon coordinate
    'Y': [main_mesh.cg['myc']-1, main_mesh.cg['myc']-1],      # y/lat coordinate
}

segment_02 = {
    'waves_event': waves_event,
    'mode': 'IJ',  # XY (coordinates) or IJ (grid)
    'X': [int(main_mesh.cg['mxc'] - main_mesh.cg['mxc']/4), main_mesh.cg['mxc']-1],  # x/lon coordinate
    'Y': [main_mesh.cg['myc']-1, main_mesh.cg['myc']-1],  # y/lat coordinate
}

segment_list = [segment_01, segment_02]
...
si.waves_mode = 'segments'
si.waves_segments = segment_list
